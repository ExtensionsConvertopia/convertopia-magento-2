...
{
    public const CRON_STRING_PATH = 'crontab/default/jobs/convertopia_order_cron/schedule/cron_expr';

    public const CRON_MODEL_PATH = 'crontab/default/jobs/convertopia_order_cron/run/model';
     /**
 ...
 */
    ...
    {
        $time = $this->getData('groups/cronScheduled/groups/orderScheduled/fields/time/value');
        $frequency = $this->getData('groups/cronScheduled/groups/orderScheduled/fields/frequency/value');
